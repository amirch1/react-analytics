        ...
        <div className="loginScreen">
            <Card title="Login" bordered={false} style={{ width: 550, height: 500, borderRadius: 6, padding: 24 }} headStyle={{ fontSize: 24, fontWeight: 700, color: '#333333'}}>
                <div className="login">
                    ...
                    <Input.Password size="large" className="input" name="password" placeholder="Password" onChange={handleInputChange}></Input.Password>
                    ...
                    <Button disabled={!loginDetails.user.length || !loginDetails.password.length || loginDetails.loggingIn} type="primary" size="large" onClick={login} className="loginBtn">Login</Button>
                </div>
            </Card>
        </div>
    );
